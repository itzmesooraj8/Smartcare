  ...
  const values = [
    {
      ...
      description: 'We treat every patient with empathy, respect, and understanding, ensuring they feel heard and valued throughout their healthcare journey.'
    },
    {
      icon: Award,
      title: 'Excellence in Medicine',
      description: 'Our commitment to medical excellence drives us to continuously improve our services and stay at the forefront of healthcare innovation.'
    },
    {
      icon: Shield,
      title: 'Patient Safety',
      description: 'Safety is our top priority. We maintain the highest standards of care and implement rigorous safety protocols to protect our patients.'
    },
    {
      icon: Globe,
      title: 'Accessibility',
      description: 'Healthcare should be accessible to everyone. We strive to break down barriers and make quality care available to all communities.'
    }
  ];
  ...
  const team = [
    {
      ...
      description: 'Leading cardiovascular specialist with over 20 years of experience in heart surgery and cardiac care.'
    },
    {
      ...
      description: 'Expert in emergency medicine with extensive experience in trauma care and critical patient management.'
    },
    {
      ...
      description: 'Dedicated pediatric specialist focused on providing comprehensive care for children and adolescents.'
    }
  ];
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      To provide exceptional, compassionate healthcare services that improve the quality of life 
                      for our patients and communities. We are committed to excellence, innovation, and 
                      accessibility in all aspects of medical care.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      To be the leading healthcare provider, recognized for our innovative approach to medicine, 
                      outstanding patient care, and positive impact on community health and wellbeing.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Our experienced medical professionals are dedicated to providing the highest 
              quality of care and leading innovation in healthcare.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              We maintain the highest standards through recognized certifications
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                title: 'HIMSS Stage 7',
                description: 'Highest level of electronic medical record adoption',
                icon: CheckCircle
              }
            ].map((cert, index) => (
